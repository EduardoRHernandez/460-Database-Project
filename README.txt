...
This repository contains the implementation of a two-tier, database-driven information management system for a ski resort. 
The system uses an Oracle Database backend hosted on aloe.cs.arizona.edu and a Java-based 
JDBC frontend application providing users with a text-based interactive interface.
